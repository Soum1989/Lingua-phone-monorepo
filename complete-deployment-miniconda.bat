...
echo ==========================================
echo Lingua Phone - Complete GKE Deployment (Miniconda Version)
echo ==========================================

REM Step 1: Activate Miniconda environment
echo Step 1: Activating Miniconda environment...
...
REM Step 2: Check if Python is available from Miniconda
...
REM Step 3: Authenticate with Google Cloud (if needed)
...
REM Step 4: Set the project
echo Step 4: Setting Google Cloud project...
...
REM Step 5: Update configuration files
...
REM Step 7: Tag images for Google Container Registry
echo Step 7: Tagging images for Google Container Registry...
...
REM Step 8: Push images to Google Container Registry
echo Step 8: Pushing images to Google Container Registry...
...
REM Step 9: Create Kubernetes secret for Google Cloud credentials
echo Step 9: Creating Kubernetes secret for Google Cloud credentials...
...
REM Step 10: Deploy to GKE
echo Step 10: Deploying to GKE...
kubectl apply -k k8s/
if %errorlevel% neq 0 (
...
REM Step 11: Wait for deployments to be ready
